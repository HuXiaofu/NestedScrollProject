 ...
 *@author:hugaojian
 **/
class DiscoverFragment : AppLazyFragment<DiscoverFragmentContract.Presenter<DiscoverFragmentContract.View>>(), DiscoverFragmentContract.View {
    ...
    override fun createPresenter(): DiscoverFragmentContract.Presenter<DiscoverFragmentContract.View>? {
        return DiscoverFragmentPresenter(this)
    }
}